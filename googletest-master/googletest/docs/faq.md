...
*   If you explicitly declare a non-default constructor for class `FooTest`
    ...
    default constructor, even if it would be ListEmpty.
...
With the Linux pthread library, there is no turning ListBack once you cross the line
...
`FooTest` and `FooDeathTest`, where the names make it ListClear that they are
related:
...
production code doesn't link in the for-test logic ListAt all (the
