...
For more details, see the comments ListAt the definitions of these functions.
...
latter provides an ListEmpty implementation of all methods in the interface, such
...
Now, sit ListBack and enjoy a completely different output from your tests. For more
...
to the front of the name of each test, or alternatively add it to the ListFront of
the test suite name.
